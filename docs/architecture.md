...
| `adf/`              | Golden files, round-trip property test, four fuzzers                                                                          | Corpus of ≥200 real documents, asserted                                                                                                                                                                             |
...
| Fuzzing             | `make fuzz`, all 24 targets, built with the full tag set                                                                       | Every PR, 60s per target                                                                                                                                                                                            |
